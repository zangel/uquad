...
void KeyFrame::MakeKeyFrame_Lite(BasicImage<byte> &im)
{
    ...
    for(int i=0; i<LEVELS; i++)
    {
        ...
        switch(mContext->ptamKeyFrameCornerDetector)
        {
        case kCornerDetectorFAST9:          pFASTFunc = &fast_corner_detect_9;                      break;
        case kCornerDetectorFAST10:         pFASTFunc = &fast_corner_detect_10;                     break;
        case kCornerDetectorFAST9_nonmax:   pFASTFunc = &fast_corner_detect_9_nonmax;               break;
        case kCornerDetectorAGAST12d:       pFASTFunc = &agast::agast7_12d::agast_corner_detect12d; break;
        case kCornerDetectorOAST16:         pFASTFunc = &agast::oast9_16::oast_corner_detect16;     break;
        default:                            pFASTFunc = &fast_corner_detect_9_nonmax;               break;
        }
        
        switch(i)
        {
        case 0: pFASTFunc(lev.im, lev.vCorners, 10); break;
        case 1: pFASTFunc(lev.im, lev.vCorners, 15); break;
        case 2: pFASTFunc(lev.im, lev.vCorners, 15); break;
        case 3: pFASTFunc(lev.im, lev.vCorners, 10); break;
...
void KeyFrame::MakeKeyFrame_Rest()
{
    ...
    for(int l=0; l<LEVELS; l++)
    {
        ...
        for(vector<ImageRef>::iterator i=lev.vMaxCorners.begin(); i!=lev.vMaxCorners.end(); i++)
        {
            ...
            if(dSTScore > mContext->ptamKeyFrameCandidateMinShiTomasiScore)
            {
                Candidate c;
                c.irLevelPos = *i;
                c.dSTScore = dSTScore;
