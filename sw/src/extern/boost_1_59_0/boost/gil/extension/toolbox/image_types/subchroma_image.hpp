...
struct subchroma_image_deref_fn
{
    ...
    result_type operator()( const point_t& p ) const
    {
        ...
        plane_locator_t v = _v_locator.xy_at( p.x / scaling_factors_t::ss_X, p.y / scaling_factors_t::ss_Y );
        plane_locator_t u = _u_locator.xy_at( p.x / scaling_factors_t::ss_X, p.y / scaling_factors_t::ss_Y );
...
private:
    ...
    template< typename L, typename F > friend class subchroma_image_view;
...
public:
    ...
    , _v_plane( y_width / base_t::ss_X, y_height / base_t::ss_Y, 0, Allocator() )
    , _u_plane( y_width / base_t::ss_X, y_height / base_t::ss_Y, 0, Allocator() )
    {
