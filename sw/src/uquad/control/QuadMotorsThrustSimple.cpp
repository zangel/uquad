...
namespace control
{
    ...
    {
        #if 1
        Vec3f rotationRate = m_RotationRateSetpoint.m_Value.cwiseMax(-Vec3f::Ones()).cwiseMin(Vec3f::Ones());
        float thrust = std::max(0.0f, std::min(1.0f, m_ThrustSetpoint.m_Value));
        #else
        #if 0
