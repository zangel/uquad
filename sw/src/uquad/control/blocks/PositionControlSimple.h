#ifndef UQUAD_CONTROL_BLOCKS_POSITION_CONTROL_SIMPLE_H
#define UQUAD_CONTROL_BLOCKS_POSITION_CONTROL_SIMPLE_H
...
#endif //UQUAD_CONTROL_BLOCKS_POSITION_CONTROL_SIMPLE_H
