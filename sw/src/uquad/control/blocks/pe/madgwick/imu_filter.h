...
#ifndef UQUAD_CONTROL_BLOCKS_PE_MADGWICK_IMU_FILTER_H
#define UQUAD_CONTROL_BLOCKS_PE_MADGWICK_IMU_FILTER_H
...
#endif // UQUAD_CONTROL_BLOCKS_PE_MADGWICK_IMU_FILTER_H
