#ifndef UQUAD_CONTROL_BLOCKS_SENSORS_H
#define UQUAD_CONTROL_BLOCKS_SENSORS_H
...
namespace blocks
{
    ...
    protected:
        ...
        LowPassFilter<float> m_BarometerAltitudeLP;
...
#endif //UQUAD_CONTROL_BLOCKS_SENSORS_H
